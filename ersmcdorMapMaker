...
public partial class MainWindow : Window
{
    ...
    private void OnViewModelPropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        ...
        if (p is nameof(MainViewModel.IsRoomSelected) or nameof(MainViewModel.IsConnectionSelected))
        {
            NoSelText.Visibility = (!ViewModel.IsRoomSelected && !ViewModel.IsConnectionSelected)
